...
```javascript
import ssort2ins from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-ssort2ins@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-ssort2ins/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-ssort2ins/actions/workflows/test.yml?query=branch:v0.1.1
